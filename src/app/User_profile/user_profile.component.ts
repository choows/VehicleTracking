...
export class UserProfileComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.userservice.getTotalNumberOfVehicle().then((result) => {
            ...
            this.TotalNumberOfBranch = this.userservice.getNumberOfBranch();
        })
    ...
    onDone() {
        this.edit = false;
        this.userservice.UpdateProfile(this.User_Name, this.Profile_image_url);
